 ...
 */
function skipVercelDeploymentChecks() {
  ...
  if (sessionStorage.getItem('vercelSkipperOpenDeployments') === 'true') {
    ...
    // Start the normal process: open section, then skip buttons
    openDeploymentChecksSection(skipButtons);
  }
}

// Execute the main function
skipVercelDeploymentChecks();
